...
tasks = ["comp_ml_long", "comp_ml_short", "comp_not_long", "comp_not_short", "comp_same_long", "comp_same_short"]
test_tasks = ["rand.comp_ml_short", "rand.comp_not_short", "rand.comp_same_short"]
#test_tasks = tasks
#test_tasks = ["comp_ml_short", "comp_not_short", "comp_same_short"]
#test_tasks = ["comp_ml_long", "comp_not_long", "comp_same_long"]
#test_tasks = tasks
#tasks = ["comp_ml_long", "comp_ml_short"]
#tasks = ["comp_ml_long"]
#tasks = ["comp_ml_long", "comp_ml_short"]
#test_tasks = ["rand.comp_ml_short"]
...
scramble_valid = lD.load_scramble_all("./testData/new/valid/", label2id, test_tasks, one_group=True)
scramble_test = lD.load_scramble_all("./testData/new/test/", label2id, test_tasks, one_group=True)

""" Convert Compositional Dataset format to SNLI dataset """
def convert_format(data, limit=-1):
    new_data = {}
...
word_vec = build_vocab(train_snli['s1'] + train_snli['s2'] +
                       ...
                       test_comp['s1'] + test_comp['s2'], GLOVE_PATH, "random_word.vectors")
...
MODEL_PATH = './newdir/model-retrain.pickle-epoch8'
#MODEL_PATH = './newdir/model-retrain-long.pickle-epoch9'
...
def evaluate(epoch, eval_type='valid', final_eval=False):
    ...
    for i in tqdm(range(0, len(s1), params.batch_size), desc="evaluate"):
        # prepare batch
...
#train_acc = evaluate(epoch, "train")
valid_comp_acc = evaluate(epoch, "valid_comp")
