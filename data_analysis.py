...
e_weighted_overlap = weighted_overlap_percentage(num_sent, s1, s2, labels, valid_labels=["entailment"])
print "entailment weighted overlap: %.5lf" % e_weighted_overlap

all_weighted_overlap = weighted_overlap_percentage(num_sent, s1, s2, labels)
print "all weighted overlap: %.5lf" % all_weighted_overlap

c_weighted_overlap = weighted_overlap_percentage(num_sent, s1, s2, labels, valid_labels=["contradiction"])
print "contradiction weighted overlap: %.5lf" % c_weighted_overlap

n_weighted_overlap = weighted_overlap_percentage(num_sent, s1, s2, labels, valid_labels=["neutral"])
print "neutral weighted overlap: %.5lf" % n_weighted_overlap
