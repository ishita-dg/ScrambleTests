...
Moreover, in order to minimize the effect of other factors such as vocabulary distribution. We intentionally modified our generation process, so that the vocabulary distribution of this New  ScrambleTest is similar to original SNLI training dataset. Only several words differ by more than %(@Demi : Is this right? Chnaged from "at leats 1%" because that was confusing) 
...
\begin{table}[htb]
  ...
  \hline
    Epoch & Train(New) & Val (SNLI) & Val (New) & Test (New)\\
    \hline
    0 & N/A & 84.73 & 46.56 & 45.36\\
    \hline
    13 & 100.0 & 55.42 & 99.8 & 99.55\\
\hline 
  \end{tabular}}
...
\begin{table}[htb]
  ...
  \begin{tabular}{||l|l|l|l|l||}
  \hline
    Epoch & Train(Combined) & Val (SNLI) & Val (New) & Test (New)\\
    \hline
